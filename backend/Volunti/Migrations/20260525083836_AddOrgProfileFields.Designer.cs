...
namespace Volunti.Migrations
{
    ...
    [Migration("20260525083836_AddOrgProfileFields")]
    partial class AddOrgProfileFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Volunti.Models.GroupMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Volunti.Models.GroupMessageAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Volunti.Models.MessageGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Volunti.Models.MessageGroupMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MessageGroupId", "UserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Volunti.Models.GroupMessage", b =>
                {
                    b.HasOne("Volunti.Models.MessageGroup", "MessageGroup")
                        .WithMany("Messages")
                        .HasForeignKey("MessageGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Volunti.Models.AppUser", "SenderUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Volunti.Models.GroupMessageAttachment", b =>
                {
                    b.HasOne("Volunti.Models.GroupMessage", "GroupMessage")
            ...
            modelBuilder.Entity("Volunti.Models.MessageGroup", b =>
                {
                    b.HasOne("Volunti.Models.AppUser", "CreatedByUser")
                        .WithMany()
