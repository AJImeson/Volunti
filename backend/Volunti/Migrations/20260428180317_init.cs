        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrgNummer = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProfilImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Volunteers_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "VolunteerVolunteerInterest",
                columns: table => new
                {
                    VolunteerInterestsId = table.Column<int>(type: "int", nullable: false),
                    VolunteersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VolunteerVolunteerInterest", x => new { x.VolunteerInterestsId, x.VolunteersId });
                    table.ForeignKey(
                        name: "FK_VolunteerVolunteerInterest_VolunteerInterests_VolunteerInterestsId",
                        column: x => x.VolunteerInterestsId,
                        principalTable: "VolunteerInterests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VolunteerVolunteerInterest_Volunteers_VolunteersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VolunteerVolunteerSkill", x => new { x.VolunteerSkillsId, x.VolunteersId });
                    table.ForeignKey(
                        name: "FK_VolunteerVolunteerSkill_VolunteerSkills_VolunteerSkillsId",
                        column: x => x.VolunteerSkillsId,
                        principalTable: "VolunteerSkills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VolunteerVolunteerSkill_Volunteers_VolunteersId",
                        column: x => x.VolunteersId,
                        principalTable: "Volunteers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VolunteerApplications_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 11111, "1", "Admin", "ADMIN", "Admin" },
                    { 22222, "2", "Volunteer", "VOLUNTEER", "Volunteer" },
                    { 33333, "3", "Organization", "ORGANIZATION", "Organization" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VolunteerApplications_JobId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VolunteerVolunteerInterest_VolunteersId",
                table: "VolunteerVolunteerInterest",
                column: "VolunteersId");

            migrationBuilder.CreateIndex(
                name: "IX_VolunteerVolunteerSkill_VolunteersId",
                table: "VolunteerVolunteerSkill",
                column: "VolunteersId");
        }
